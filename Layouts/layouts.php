...
?>
    ...
    public function form_content($conf, $ObjForms, $ObjFncs) {
?>
            <div class="row align-items-md-stretch">
               <div class="col-md-6">
                  <div class="h-100 p-5 text-bg-dark rounded-3">
                     <?php if(basename($_SERVER['PHP_SELF']) == 'signup.php') {$ObjForms->signup($conf, $ObjFncs);} elseif(basename($_SERVER['PHP_SELF']) == 'signin.php') {$ObjForms->signin($conf, $ObjFncs);} ?>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="h-100 p-5 bg-body-tertiary border rounded-3">
...
<script src="<?php echo $conf['site_url']; ?>js/bootstrap.min.js" crossorigin="anonymous"></script>
   </body>
</html>
<?php
    }
